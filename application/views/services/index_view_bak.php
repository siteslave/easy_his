...
<div class="navbar navbar-default">
    ...
    <input type="text" style="width: 200px;" id="txt_query_visit" class="form-control"
    rel="tooltip" title="พิมพ์ชื่อ หรือ HN หรือ เลขบัตรประชาชน เพื่อค้นหา" autocomplete="off" placeholder="HN, ชื่อ สกุล...">
    <button type="button" id="btn_do_search_visit" class="btn btn-primary" rel="tooltip" title="ค้นหารายการ">
        <i class="fa fa-search"></i>
    </button>
   |
    <input style="width: 100px;" class="form-control" id="txt_service_date" type="text" value="<?=get_current_date()?>"
    ...
    -->
    <select style="width: 200px;" id="sl_service_doctor_room" class="form-control">
    ...
    <div class="btn-group pull-right">
        ...
        <button type="button" data-style="slide-up" class="btn btn-default" id="btn_refresh_visit" title="รีเฟรช" rel="tooltip">
            <span class="fa fa-refresh"></span>
        </button>
    </div>
</form>
</div>
<table class="table table-striped" id="tbl_service_list">
    <thead>
    <tr>
        <th>HN</th>
        <th>ชื่อ - สกุล</th>
    ...
    <div class="modal-dialog" style="width: 960px;">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><i class="fa fa-file-alt"></i> ลงทะเบียนส่งตรวจ</h4>
            </div>
...
<div class="modal fade" id="modal_search_person">
    <div class="modal-dialog" style="width: 960px;">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title"><i class="fa fa-search"></i> ค้นหาผู้ป่วย</h4>
            </div>
                            ...
                            <div class="control-group">
                                <div class="controls">
                                    <div class="input-append">
                                        ...
                                        <div class="btn-group">
                                            <button class="btn btn-info" id="btn_do_search_person" type="button"><i class="fa fa-search"></i> ค้นหา</button>
                                            <button type="button" class="btn btn-info dropdown-toggle" data-toggle="dropdown" tabindex="-1">
                                                <span class="caret"></span>
                                            </button>
                                            <ul class="dropdown-menu">
                                                <li><a href="javascript:void(0);" id="btn_reg_search_person_by_name"><i class="fa fa-user"></i> ค้นจากชื่อ - สกุล</a></li>
                                                <li><a href="javascript:void(0);" id="btn_reg_search_person_by_cid"><i class="fa fa-barcode"></i> ค้นจากเลขบัตรประชาชน (CID)</a></li>
                                                <li><a href="javascript:void(0);" id="btn_reg_search_person_by_hn"><i class="fa fa-bookmark"></i> ค้นจาก HN</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger" data-dismiss="modal"><i class="fa fa-off"></i> ปิดหน้าต่าง</button>
            </div>
        </div>
    </div>
</div>
