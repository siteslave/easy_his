<ul class="breadcrumb">
    ...
    <li class="active">ทะเบียนหญิงตั้งครรภ์และหญิงหลังคลอด 6 สัปดาห์ (ANC)</li>
</ul>
...
<table class="table table-striped table-hover" id="tbl_anc_list">
    <thead>
    <tr>
        <th>HN</th>
        <th>CID</th>
...
<script type="text/javascript">
    head.js('<?php echo base_url(); ?>assets/apps/js/apps.ancs.index.js');
</script>
