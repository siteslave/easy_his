...
<div class="modal hide fade" id="mdlNewRegister">
    <div class="modal-header">
        ...
        <h3>ลงทะเบียนผู้ป่วยความดัน (HT)</h3>
    </div>
    <div class="modal-body">
        <div class="alert alert-info" id="alert_regis_ht">
    ...
    <div class="modal-footer">
        <button type="button" class="btn btn-success" id="btn_ht_do_register"><i class="icon-plus-sign icon-white"></i><span id="lblRegis" title="add">ลงทะเบียน</span></button>
