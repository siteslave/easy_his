...
<div class="navbar navbar-default">
    <form action="#" class="navbar-form">
        ...
        <select id="sl_village" style="width: 255px;" class="form-control">
    ...
    <div class="modal-dialog" style="width: 960px;">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><i class="fa fa-plus-circle"></i> ลงทะเบียนผู้ป่วยเบาหวาน (DM)</h4>
            </div>
            <div class="modal-body">
                <form class="form-inline well well-small">
                    ...
                    <input type="hidden" id="txt_isupdate" value="" />
                ...
                <form action="#" class="form-inline">
                    <div class="row">
                        <div class="col-lg-2">
                            ...
                            <input type="text" id="tboHN" class="form-control" placeholder="HN" disabled />
                        </div>
                        <div class="col-lg-3">
                            <label class="control-label" for="tboCid">เลขบัตรประชาชน</label>
                            <input type="text" id="tboCid" class="form-control" placeholder="เลขบัตรประชาชน" disabled />
                        </div>
                        <div class="col-lg-3">
                            <label class="control-label" for="tboFname">ชื่อ</label>
                            <input type="text" id="tboFname" class="form-control" placeholder="ชื่อผู้ป่วย" disabled />
                        </div>
                        <div class="col-lg-3">
                            <label class="control-label" for="tboLname">นามสกุล</label>
                            <input type="text" id="tboLname" class="form-control" placeholder="นามสกุล" disabled />
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-2">
                            <label class="control-label" for="tboAge">อายุ</label>
                            <input type="text" id="tboAge" class="form-control" placeholder="อายุ" disabled />
                        </div>
                        <div class="col-lg-2">
                    ...
                    <div class="row">
                        <div class="col-lg-2">
                            ...
                            <input type="text" id="tboYear" class="form-control" placeholder="พ.ศ. เช่น 2556" data-type="year" />
                        </div>
                        <div class="col-lg-3">
                            <label class="control-label" for="dtpRegisDate">วันที่ขึ้นทะเบียน</label>
                            <input value="" type="text" class="form-control" id="dtpRegisDate" data-type="date" />
                        </div>
                        <div class="col-lg-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2">
                            ...
                            <input type="text" id="txt_discharge_date" class="form-control"
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-success" id="btn_dm_do_register">
                    <i class="fa fa-save"></i><span id="lblRegis" title="add"> บันทึกข้อมูล</span>
                </button>
