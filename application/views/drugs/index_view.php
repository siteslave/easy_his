...
<div class="navbar navbar-default">
    <form action="#" class="navbar-form form-inline">
        ...
        <input style="width: 350px;" class="form-control" id="txt_query" type="text" placeholder="พิมพ์ชื่อยา..."
    ...
    <div class="modal-dialog" style="width: 960px;">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><i class="fa fa-briefcase"></i> แก้ไขรายการยา</h4>
            </div>
            <div class="modal-body">
                <form action="#" class="">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <label for="txt_reg_did">รหัสมาตรฐาน</label>
                            <input type="text" class="form-control" disabled="disabled" id="txt_reg_did" data-type="number" />
                        </div>
                        <div class="col-lg-4">
                            <label for="txt_reg_name">ชื่อยา</label>
                            <input class="form-control" type="text" disabled="disabled" id="txt_reg_name" />
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-2">
                            <label for="txt_reg_unit_cost">ราคาซื้อ (บาท)</label>
                            <input type="text" class="form-control" disabled="disabled" data-type="number" id="txt_reg_unit_cost" />
                        </div>
                        <div class="col-lg-2">
                            <label for="txt_reg_unit_price">ราคาขาย (บาท)</label>
                            <input type="text" class="form-control" data-type="number" id="txt_reg_unit_price" />
                        </div>
                        <div class="col-lg-2">
                            <label for="txt_reg_qty">คงเหลือ</label>
                            <input type="text" class="form-control" data-type="number" id="txt_reg_qty" />
                        </div>
                    </div>
                </form>
            </div>
