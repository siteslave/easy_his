...
head.ready(function(){
    ...
    $('a[data-name="btn_selected_charge"]').on('click', function(){
    ...
    $('a[data-name="btn_selected_charge_usage"]').on('click', function(){
        var id = $(this).attr('data-id'),
            name = $(this).attr('data-vname');
    ...
    $('a[data-name="btn_charge_edit"]').on('click', function(){
        var id = $(this).attr('data-id'),
    ...
    //remove charge
    $('a[data-name="btn_charge_remove"]').on('click', function(){
